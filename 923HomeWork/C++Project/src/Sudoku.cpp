...
void Sudoku::parse(std::string str){
    ...
    this->BOX_SIZE = bs;
    this->GRID_SIZE = gs;
    this->grid = new int*[gs];
    for(int i = 0;i < gs;i++){
        this->grid[i] = new int[gs];
        for(int j = 0;j < gs;j++){
